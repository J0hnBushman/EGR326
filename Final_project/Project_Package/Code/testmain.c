...
- [ ] EEPROM
- [x] WATCHDOG TIMER
- [x] Only want one servo on at a time
- [x] Add sound to states
- [x] Want to fix the light sensor to be more precise
				...
				case mainMenu:
					default:
						//RESET VARIABLES
							...
							Rotate_Display(0);
							Fill_Screen(BROWN); //Moves sp l to R, moves sp t to b /*NOTE THIS IS JUST TO CLEAR THE OLD TXT THERE, while keep the time at top*/
							Read_Date();
