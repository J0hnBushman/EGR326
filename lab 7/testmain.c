...
int main(void)
{
    ...
    //doFontTest(&font_ubuntu_mono_24); // Prints every character in the font_ubuntu_mono_24 font header.
	  delayMS(1000);
    Draw_String_NoBG(50, 100, "Place Holder", WHITE, &font_ubuntu_mono_24);
		Draw_String_NoBG(50, 120, "Place Holder", WHITE, &font_ubuntu_mono_24);
		Draw_String_NoBG(50, 140, "Place Holder", WHITE, &font_ubuntu_mono_24);
		Draw_String_NoBG(50, 160, "Place Holder", WHITE, &font_ubuntu_mono_24);
